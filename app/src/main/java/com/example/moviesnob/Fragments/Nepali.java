...
public class Nepali extends Fragment {
    ...
    public void jsoncall( int a) {
        ...
        String URL_JSON = "https://api.themoviedb.org/3/discover/movie?api_key=c95a6dccccd66a359cf6e9a0a7d8c665&region=NP&sort_by=popularity.desc&include_adult=false&include_video=false&with_original_language=ne&page="+a;
